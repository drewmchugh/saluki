...
pub static SALUKI_KEYS: &[SalukiKey] = &[
    // ── metrics_endpoint_routing_experimental.rs ───────────────────────────
    SalukiKey {
        yaml_path: "metrics_endpoint_routing_experimental.metric_allowlist",
        ...
        documentation: Some(concat!(
            ...
            "Key `metrics_endpoint_routing_experimental.metric_allowlist` by the exact configured endpoint string. ",
            "For the ",
        ...
        filename: "metrics_endpoint_routing_experimental.rs",
    },
    // ── data_plane.rs ────────────────────────────────────────────────────────
    SalukiKey {
